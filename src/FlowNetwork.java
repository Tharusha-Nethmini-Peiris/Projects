...
public class FlowNetwork {
    ...
    /* Returns true if there is a path from source 's' to
      ...
      store the path */
    static boolean bfs(int[][] rGraph, int source, int destination, int[] parent) {
    ...
    // graph
    static int fordFulkerson(int[][] graph, int source, int destination) {
        int u, v;
    ...
    public static void main(String[] args)
        ...
        FlowNetwork fordFulkerson = new FlowNetwork();
        max_flow = fordFulkerson.fordFulkerson(graph, source, sink);
